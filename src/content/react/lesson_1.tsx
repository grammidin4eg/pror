...
import {QuestionCircleOutlined, ApartmentOutlined, AppstoreAddOutlined} from '@ant-design/icons';
import '../content.css'
...
export const ReactLesson1: React.FC = () => (
    <div>
        ...
        <div className="content">
            ...
            <QuestionCircleOutlined /><h3 className='ml'>Зачем использовать ReactJS?</h3>
            <ul>
            ...
            <ApartmentOutlined /><h3 className='ml'>Virtual dom</h3>
            <p>
            ...
            <AppstoreAddOutlined /><h3 className='ml'>Компоненты</h3>
            <p>
